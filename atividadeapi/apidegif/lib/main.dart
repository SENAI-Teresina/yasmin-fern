...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      theme: ThemeData(
        scaffoldBackgroundColor: const Color.fromARGB(255, 0, 167, 6), // Definindo o fundo preto para todo o aplicativo
      ),
    );
  }
}
...
class _HomePageState extends State<HomePage> {
  ...
  return Scaffold(
    appBar: AppBar(
      title: const Text(
        'Galeria dos melhores gifs',
        style: TextStyle(color: Colors.white), // Definir a cor do texto
      ),
      backgroundColor: const Color.fromARGB(255, 0, 167, 6),
    ),
    body: FutureBuilder(
      future: _listGifs,
...
class GifPage extends StatelessWidget {
  ...
  return Scaffold(
    appBar: AppBar(
      ...
      iconTheme: const IconThemeData(color: Colors.white), // Definir a cor do ícone de compartilhamento
      actions: [
        IconButton(
